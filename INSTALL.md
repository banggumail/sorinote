...
## 4. 소리노트 기본 사용 방법 (Usage Guide)

설치 완료 후 서비스를 이용하는 방법과 관리자 기능을 설명합니다.

### 4-1. 관리자 페이지 (Admin Dashboard)
...
### 4-2. 사용자 협업 화면 (Collaborative Board)
...
## 5. 포트 번호 변경 방법 (Port Configuration)
...
## 6. 최대 업로드 용량 제한 설정 및 업데이트 방법 (Upload Size Limit Configuration)
