    ...
    >
      ...
      <div 
        ...
        style={{ 
          ...
          borderRadius: '50%', background: 'white', border: isWhiteOrVeryLight(outerBgColor || '#E0E0D0') ? '2px ridge #d0d0d0' : '2px ridge #ffffff',
      ...
      {activeMemoId && memos.find(m => m.id === activeMemoId) && (() => {
        ...
        return (
          <div 
            ...
            background: activeMemo.color || 'white', border: isWhiteOrVeryLight(outerBgColor || '#E0E0D0') ? '2px ridge #d0d0d0' : '2px ridge #ffffff', 
      ...
      >
        <div style={{
          ...
          border: isWhiteOrVeryLight(outerBgColor || '#E0E0D0') ? '2px ridge #d0d0d0' : '2px ridge #ffffff',
          boxShadow: 'none',
          display: 'flex',
          flexDirection: 'column',
          alignItems: 'center',
      ...
      <div onPointerDown={(e) => e.stopPropagation()} style={{ position: 'fixed', bottom: '20px', left: '50%', transform: `translateX(-50%) scale(${uiScale})`, transformOrigin: 'bottom center', zIndex: 2000, display: 'flex', flexDirection: 'column', alignItems: 'center', pointerEvents: 'auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'white', padding: '4px 10px', border: isWhiteOrVeryLight(outerBgColor || '#E0E0D0') ? '2px ridge #d0d0d0' : '2px ridge #ffffff', width: '250px', height: '40px', boxSizing: 'border-box' }}>
        {(() => {
